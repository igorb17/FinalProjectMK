...
class Product
{
    ...
    public function latestFromValve()
    {
    ...
    public function latestFromHoi4()
    {
    ...
    public function getBrandProductGta()
    {
